    ...
    <div className={styles.androidLarge1}>
      <div className={styles.frameParent}>
        <div className={styles.frameGroup}>
          ...
          <div className={styles.thunderAnimationParent}>
            <img
          ...
          <div className={styles.frameContainer}>
            {/* <div className={styles.frameDiv}>
              ...
              <div className={styles.invoiceDiscountingParent}>
                ...
                <div className={styles.secureFinancingBy}>
                  Secure financing by selling your unpaid invoices to investors
            ...
            <div className={styles.frameParent2}>
              ...
              <div className={styles.invoiceDiscountingParent}>
                ...
                <div className={styles.secureFinancingBy}>
                  Access Business Loan at lower rates than traditional
                  financing options.
                </div>
              </div>
            </div>
      ...
      <div className={styles.frameParent4}>
        ...
        <div className={styles.welcomeToRollovermoney}>
          Grow your business with easy access to Business Loan financing in a click and fund disbursement within 3 working days
        </div>
      ...
      <div className={styles.frameParent44}>
        ...
        <div className={styles.callCenterBro1Wrapper}>
          <img
          ...
          <div className={styles.frameParent48}>
            <div className={styles.servicesParent}>
              ...
              <div className={styles.itemInvoicingToolParent}>
                ...
                <div
                  className={styles.itemInvoicing}
